...
/**
 * Adapts the {@link com.jgraph.io.svg.SVGEdgeWriter} for representing CTGs and
 * APCGs
 * 
 * @author cipi
 * 
 */
public class SvgEdgeWriter extends com.jgraph.io.svg.SVGEdgeWriter {
	...
	public Node createNode(SVGGraphWriter writer, Document document,
		...
		if (view instanceof EdgeView) {
			...
			if (lineBegin != GraphConstants.ARROW_NONE) {
...
//				href.appendChild(startMarker);
			...
			// TODO should draw arrows correctly instead of only having one type
			if (lineEnd != GraphConstants.ARROW_NONE) {
